...
are based on analyzing model sensitivity to semantically meaningful concepts \cite{kim_tcav, shi_concept},
which may be generated automatically as in the approach proposed by \citeA{kim_ace}. This techniques, although
very promising, are still to recent and are not extensible to many domains.
