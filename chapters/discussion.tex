...
on neural network  training. Sections two and three will show the quantitative relationship between
segmentation, and the perception quantification. And finally, on section four we will
...
By analyzing SelfSegRank we can see the impact the ResNet features have on the model  behavior
...
the sole input. An example of this difference can be seen comparing figure \ref{fig:correlation_selfsegrank} and
figure \ref{fig:correlations:wealthy}.
...
\begin{figure}[ht]
	...
	\caption[SelfSegRank Correlation]{
		...
		SelfSegRank model. Example for the wealthy attribute.
        }
